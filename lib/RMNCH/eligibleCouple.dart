        ...
        child: Column(
          children: [
            ...
            radioContainer(
              ...
              selectedButton: method, fun: (int k) {  },
            ),
            method == 1
                ? Column(
                    children: [
                    ...
                    ? Column(
                        children: [
                          radioContainer(
                            ...
                            selectedButton: tempster, fun: (int k) {  },
                          ),
                          tempster == 1
                              ? Cont(
                                  child: Row(
                        ...
                        ? Column(
                            children: [
                              ...
                              radioContainer(
                                ...
                                selectedButton: result, fun: (int k) {  },
                              ),
                            ],
                          )
                        : method == 4
                            ? Column(
                                children: [
                                  ...
                                  radioContainer(
                                    ...
                                    selectedButton: reason, fun: (int k) {  },
                                  ),
                                  reason == 3
                                      ? radioContainer(
                                          name:
                                          ...
                                          selectedButton: newmode, fun: (int k) {  },
                                        )
                                      : const SizedBox(),
                                ],
                              )
